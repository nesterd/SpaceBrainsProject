...
public abstract class AuthConstants {
    ...
    public static final String ERR_UNAUTHORIZED         =   "Ошибка авторизации";
    ...
    public static final String PSWD_RESTORED            =   "Проверьте почтовый ящик";
    ...
    public static final String USER_LOGIN_EMPTY         =   "Не заполнен логин";
    public static final String USER_LOGIN_TOO_LONG      =   "Логин д.б. не более 15 символов";

    public static final String USER_PSWD_EMPTY          =   "Не заполнен пароль";
    ...
    public static final String USER_EMAIL_EMPTY         =   "Не заполнен e-mail";
