...
public abstract class AuthConstants {
    ...
    public static final String ERR_WRONG_LOGIN = "Указанный логин не найден";
    public static final String ERR_WRONG_PWSD = "Неверный пароль";
    public static final String ERR_IS_USER = "Воспользуйтесь <a href='" + USER_WEB_INTERFACE_LINK + "'>Web-версией</a>, пожалуйста";
}
