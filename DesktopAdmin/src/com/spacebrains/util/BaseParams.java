...
public abstract class BaseParams {
    ...
    public static final Font BASE_LABEL_FONT = getBaseFont(18);
    public static final Font BASE_BTN_FONT = getBaseFont(18);
    ...
    public static final Font BASE_MENU_FONT = getBaseFont(16);

    public static Font getBaseFont(int size) {
        return new Font(MONOTYPE, Font.PLAIN, size);
    }

    public static void setDefaultFont() {
        FontUIResource f = new FontUIResource(new Font(MONOTYPE, 0, 15));
